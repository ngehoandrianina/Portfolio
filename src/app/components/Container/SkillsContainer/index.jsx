...
const SkillsContainer = ({src,value,Title}) => {
  return (
    <motion.div initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} transition={{duration:0.7}} viewport={{margin:"-100px"}} className=' border border-gray-400 h-32 md:h-40 md:w-96 rounded-xl relative px-6 py-4 flex flex-col justify-evenly shadow-md shadow-primary'>
