    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="flex flex-col flex-wrap md:flex-row gap-4">
          ...
          />
          <SkillsContainer
            src={"/logo/materialui.png"}
            value={60}
            Title={"MATERIAL UI"}
          />
          <SkillsContainer
            src={"/logo/tailwindcss.jpg"}
            value={80}
            Title={"TAILWIND CSS"}
          />
          <SkillsContainer
            src={"/logo/bootstrap.jpg"}
            value={70}
            Title={"BOOTSTRAP"}
          />
        </div>
      ...
      <div>
        ...
        <div className="flex flex-col flex-wrap md:flex-row gap-4">
          ...
          />
          <SkillsContainer
            src={"/logo/fastapi.jpg"}
            value={50}
            Title={"FAST API"}
          />
          <SkillsContainer
            src={"/logo/springboot.jpg"}
            value={40}
            Title={"SPRING BOOT"}
          />
          <SkillsContainer
            src={"/logo/laravel.jpg"}
            value={40}
            Title={"LARAVEL"}
          />
        </div>
